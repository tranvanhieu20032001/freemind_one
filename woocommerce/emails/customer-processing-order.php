...
<!-- Thêm CSS inline vào các bảng chứa địa chỉ -->
<div style="display: flex; justify-content: space-between;">
    <div style="width: 48%; vertical-align: top;">
        <h2 style="font-size: 14px; font-weight: bold; margin-bottom: 10px;"><?php esc_html_e( 'Billing address', 'woocommerce' ); ?></h2>
        <address>
    ...
    <div style="width: 48%; vertical-align: top;">
        <h2 style="font-size: 14px; font-weight: bold; margin-bottom: 10px;"><?php esc_html_e( 'Shipping address', 'woocommerce' ); ?></h2>
        <address>
